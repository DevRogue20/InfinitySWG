		...
		if #statTable ~= 0 then
			...
			if (pQualityWinner ~= nil) then
				...
				if pInventory ~= nil then
					...
					if pItem ~= nil and pItem then
						util:l("Village Crafting phase " .. currentPhase .. " qualityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 5 use Crafting tool delivered", nil, 3)
					else
						util:l("Village Crafting phase " .. currentPhase .. " qualityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 5 use Crafting tool FAILURE", nil, 3)
					end
				end
			end
			...
			if (pQuantityWinner ~= nil) then
				...
				if pInventory ~= nil then
					...
					if pItem ~= nil and pItem then
						util:l("Village Crafting phase " .. currentPhase .. " quantityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 5 use Crafting tool delivered", nil, 3)
					else
						util:l("Village Crafting phase " .. currentPhase .. " quantityWinner for ingredient #" .. i .. " [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 5 use Crafting tool FAILURE", nil, 3)
					end
				end
			end
		end
	...
	if (#overallQuality > 0) then
		...
		if (pQualityWinner ~= nil) then
			...
			if pInventory ~= nil then
				...
				if pItem ~= nil and pItem then
					util:l("Village Crafting phase " .. currentPhase .. " overall qualityWinner [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 20 use Crafting tool delivered", nil, 3)
				else
					util:l("Village Crafting phase " .. currentPhase .. " overall qualityWinner [" .. CreatureObject(pQualityWinner):getFirstName() .. "]: 20 use Crafting tool FAILURE", nil, 3)
				end
			end
		end
	end
	...
	if (#overallQuantity > 0) then
		...
		if (pQuantityWinner ~= nil) then
			...
			if pInventory ~= nil then
				...
				if pItem ~= nil and pItem then
					util:l("Village Crafting phase " .. currentPhase .. " overall quantityWinner [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 20 use Crafting tool delivered", nil, 3)
				else
					util:l("Village Crafting phase " .. currentPhase .. " overall quantityWinner [" .. CreatureObject(pQuantityWinner):getFirstName() .. "]: 20 use Crafting tool FAILURE", nil, 3)
				end
			end
		end
	end
