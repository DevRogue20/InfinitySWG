...
function HeroOfTatooineScreenPlay:doCourageChange()
	...
	if spawnPoint == nil then
		createEvent(60 * 1000, "HeroOfTatooineScreenPlay", "doCourageChange", "", "")
		util:l("error hero of tat spawn: x=" .. ostring(x) .. ", y=" .. tostring(y), nil, 3)
		printLuaError("Failed to create leader in HeroOfTatooineScreenPlay:doCourageChange().")
	end
...
function HeroOfTatooineScreenPlay:doAltruismChange()
	...
	local spawnPoint = getSpawnPoint("tatooine", x, y, 10, 128)
	if spawnPoint == nil then
		createEvent(60 * 1000, "HeroOfTatooineScreenPlay", "doAltruismChange", "", "")
		util:l("error hero of tat spawn: x=" .. ostring(x) .. ", y=" .. tostring(y), nil, 3)
...
function HeroOfTatooineScreenPlay:doHonorChange()
	...
	if spawnPoint == nil then
		createEvent(60 * 1000, "HeroOfTatooineScreenPlay", "doHonorChange", "", "")
		util:l("error hero of tat spawn: x=" .. ostring(x) .. ", y=" .. tostring(y), nil, 3)
