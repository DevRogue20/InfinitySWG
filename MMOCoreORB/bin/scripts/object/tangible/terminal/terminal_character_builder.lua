			...
			"Deeds",
			{
				...
				"Structure Deeds",
				{
					...
					"Kashyyyk Structures",
					{
						...
						"City Hall [special] Schem", "object/tangible/loot/loot_schematic/kash_tree_special_cityhall_loot_schem.iff",
						...
						"City Hall Schem", "object/tangible/loot/loot_schematic/kash_tree_cityhall_loot_schem.iff",
