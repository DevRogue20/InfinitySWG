...
corellia = {
	...
	planetObjects = {
		...
		{templateFile = "object/tangible/beta/beta_terminal_wound.iff", ox = 0, oy = -0.664289, oz = 0, ow = 0.747476, x = -136.516, z = 28, y = -4733.98, parentid = 0},  -- Coronet Starport New Player Terminal
		...
		{templateFile = "object/tangible/terminal/terminal_space.iff", ox = 0, oy = -0.70711, oz = 0, ow = 0.70711, x = 1587.2, z = 47.6, y = 3872.2, parentid = 0},   -- Swamptown ETA Travel Terminal
...
kashyyyk = {
	...
	--]]
	planetTravelPoints = {
		{name = "Azure Veil Mine", x = -2899, z = 16, y = -2202, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
		{name = "Krsss-Forak", x = 7389, z = 4, y = -4617, interplanetaryTravelAllowed = 0, incomingTravelAllowed = 1},
	},
	--[[
	badgeAreas = {
...
naboo = {
	...
	planetTravelPoints = {
		...
		{name = "ZeroZero Shuttleport", x = 0, z = 20, y = 0, interplanetaryTravelAllowed = 1, incomingTravelAllowed = 1}
	},
