...
corellia_regions = {
	...
	{"sdungeon_rogue_corsec_bunker", 5225, 1567, {CIRCLE, 128}, NOSPAWNAREA + NOBUILDZONEAREA + NAVAREA},
	...
	--[[ Infinity ]]
	-- Mandalorian
	{"mandobunker_1", -6620, -3732, {CIRCLE, 96}, NOSPAWNAREA + NOBUILDZONEAREA},
	{"mandobunker_2", 6721, -6116, {CIRCLE, 96}, NOSPAWNAREA + NOBUILDZONEAREA},
